...
Dim bdata(0 To ONE_SPCMA_SIZE - 1) As Byte
...
Sub DoModal(ByVal no As Integer)
    ...
    End If
    Seek #fno, TOP_SPCMA + no * ONE_SPCMA_SIZE
    Get fno, , bdata
    Close fno
...
Private Sub cmdAnnounce_Click()
    ...
    If frmSequence.DoModal(sdata, "Special " & Trim$(selno + 1) & " Announce Code Define", SEQUENCE_MAX) = False Then Exit Sub
